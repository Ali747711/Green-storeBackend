...
export const register = async (req, res) => {
  try {
    ...
    res.json({
      success: false,
      message: `Error message in register: ${error.message}`,
    });
  }
};
...
export const login = async (req, res) => {
  try {
    ...
    res.json({
      success: false,
      message: `Error message in login: ${error.message}`,
    });
  }
};
...
export const isAuth = async (req, res) => {
  try {
    ...
    res.json({
      success: false,
      message: `Error message in isAuth: ${error.message}`,
    });
  }
};
...
export const logout = async (req, res) => {
  try {
    ...
    res.json({
      success: false,
      message: `Error message in logout: ${error.message}`,
    });
  }
};
